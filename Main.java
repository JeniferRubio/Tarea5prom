...
public class Main 
{
    //creamos un metodo main esta nos ayudará con la ejecución del programa esta debe ser static
    public static void main(String[] args) {    
        
        Promedio promedio1 = new Promedio(14.00, 15.00, 16.00, 18.00, 11.00,13.00);
                                        //el argumento lo vamos a utilizar para recibir valores de entrada
