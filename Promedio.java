...
public class Promedio
 {
    ...
    {
      setTa1(n1);
      setTa2(n2);                       //el constructor nos va ayudar a inicializar nuestra instancia
      setTa3(n3);
      setTa4(n4);
      setMedioCurso(emc);
      setExaFinal(efc);
     ...
     void setTa1(double n1)   //encapsulamos para que envuelve los datos y métodos en una sola unidad.
     {
        ta1=n1;
     }
     double getTa1()
